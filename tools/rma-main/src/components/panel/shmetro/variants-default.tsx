        ...
        <>
            <Card sx={{ ...cardStyle, height: '450px' }} variant="outline">
                ...
                <CardBody>
                    ...
                    <RmgLabel label="Terminal name pronunciation">
                        <RmgDebouncedInput
                    ...
                    <RmgLabel label="Line name pronunciation">
                        <RmgDebouncedInput
                    ...
                    <RmgLabel label="Service type">
                        <RmgOutput>{service}</RmgOutput>
                    </RmgLabel>
                    <RmgLabel label="Note last train transfer times" oneLine>
                        <Switch
                    ...
                    {loop !== 'none' && (
                        <>
                            <RmgLabel label="Loop direction">
                                ...
                                >
                                    <Radio value="inner">Inner loop</Radio>
                                    <Radio value="outer">Outer loop</Radio>
                                </RadioGroup>
                            </RmgLabel>
                            <RmgLabel label="Loop terminal" oneLine>
                                <Switch
            ...
            <Card sx={{ ...cardStyle, height: '150px' }} variant="outline">
                ...
                <CardBody>
                    <RmgLabel label="Safety reminder" oneLine>
                        <Switch
                            isChecked={caution}
                            onChange={({ target: { checked } }) =>
                                handleVariantChange(
