...
const validVariants = [
    [Stage.Departure, VoiceName.ChineseMandarinSimplified, 'Departure (Mandarin)'],
    [Stage.Arrival, VoiceName.ChineseMandarinSimplified, 'Arrival (Mandarin)'],
    [Stage.Midway, VoiceName.ChineseMandarinSimplified, 'Midway (Mandarin)'],
    [Stage.Departure, VoiceName.ChineseWuSimplifiedYunzhe, 'Departure (English)'],
    [Stage.Arrival, VoiceName.ChineseWuSimplifiedYunzhe, 'Arrival (English)'],
