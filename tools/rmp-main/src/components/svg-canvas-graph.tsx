...
import { getLinePathAndStyle, LineId, MiscNodeId, NodeId, StnId } from '../constants/constants';
...
const SvgCanvas = () => {
    ...
    const {
        preference: { autoParallel, snapLines: useSnapLines, autoChangeStationType, keepLastPath },
